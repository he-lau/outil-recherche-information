  ...
  <head>
    ...
    <style>
      #modal-wordcloud {
        ...
        position: fixed;
        top: 50%; /* Le modal sera centré verticalement */
        left: 50%; /* Le modal sera centré horizontalement */
        transform: translate(-50%, -50%); /* Centrer le modal précisément */
        background-color: white;
        padding: 20px;
        height: fit-content;
        overflow: auto;
        width: fit-content; /* Vous pouvez ajuster la largeur selon vos besoins */
